...
var mixi = new mb.UnitActionPackage('Services.Mixi', {
  label : 'mixi',
  icon : 'http://mixi.jp/favicon.ico'
});

mixi.register(new mb.UnitAction({
  type : 'Friends',
  ...
  execute : function(request, callback) {
    ...
    mb.ajax.request({
      ...
      function(doc) {
        ...
        var diaries = mb.lang.map(divs, function(div) {
...
mb.packages.register(mixi, 'mixi.js');
