...
var LibraryPanel = function(el, config) {
  ...
  var packages = mb.packages.listPackages();

  mb.lang.forEach(packages, this.appendPackage, this);
...
Ext.extend(LibraryPanel, Ext.NestedLayoutPanel, {
  loadExtraPackages : function() {
    mb.packages.addListener('register', this.appendPackage, this);
    mb.lang.loadScript(mb.packages.scriptBaseURL+'/mb-stdlib-index.js');
  }
  , 
  createPackageNode : function(pack) {
    ...
    mb.lang.forEach(pack.listUnitActions(), function(uaction) {
