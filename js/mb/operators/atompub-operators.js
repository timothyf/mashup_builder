...
var atomPubPostOperator = new mb.UnitAction({
  type : 'atompubpost',
  label : 'AtomPub POST',
  ...
  execute : function(request, callback) {
	...
	var	mycallback = {
        onSuccess: function(data){
	        callback.onSuccess(mb.lang.xmlToJson(data));
        },
...
var atomPubOperatorsPackage = new mb.UnitActionPackage('AtomPub Operators');
atomPubOperatorsPackage.register(atomPubPostOperator);
mb.packages.register(atomPubOperatorsPackage, 'atompub-operators.js');
