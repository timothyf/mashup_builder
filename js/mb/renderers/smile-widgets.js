...
var smileWidgets = new mb.UnitActionPackage('Renderer.SmileWidgets', {
  label : 'Smile Widgets'
});

smileWidgets.register(new mb.RenderingUnitAction({
  type : 'Timeplot',
  label : 'Timeplot',
...
smileWidgets.register(new mb.RenderingUnitAction({
  ...
  render : function(params, el) {
    ...
    mb.lang.forEach(records, function(r, i) {
      ...
      var start = mb.lang.cast('String', r[initialDate] || r);
      var end   = mb.lang.cast('String', r[finalDate] || r);
...
mb.packages.register(smileWidgets, 'smile-widgets.js');
