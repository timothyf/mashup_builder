...
var EL = new function() {
  ...
  function scanObject(obj, matchFn, applyFn) {
    ...
    if (mb.lang.isPrintable(obj)) { // leaf property, pseudo primitive.
      return obj;
    } 
  ...
  return {
    extractVars : function(obj) {
      var refs = [];
      var hash = {};
      scanObject(obj, mb.lang.isString, _extractVars);
      return refs;
    ...
    evaluate: function(context, obj) {
      return scanObject(obj, mb.lang.isString, _evalReference);
