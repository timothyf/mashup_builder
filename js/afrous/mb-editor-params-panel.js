...
Ext.extend(ParamsPanel, Ext.NestedLayoutPanel, {
  loadConfig : function(paramCfgs) {
    mbuilder.lang.forEach(paramCfgs, function(conf) {
      var val = conf['default'] && mbuilder.lang.cast(conf.type, conf['default']);
  ...
  handleParamDef: function(conf) {
    if (conf.name && conf.type) {
      ...
      var val = conf['default'] && mbuilder.lang.cast(type, conf['default']);
