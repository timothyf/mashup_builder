...
var dpipesOperator = new afrous.UnitAction({
  type : 'dpipes',
  label : 'DERI Pipes',
...
//		afrous.ajax.jsonp.invoke(dpipes_string, callback); 
...
var dpipesPackage = new afrous.UnitActionPackage('Services.Dpipes', {
  label : 'DERI Pipes',  
  icon : 'http://pipes.deri.org/templates/rhuk_milkyway/favicon.ico'
});

dpipesPackage.register(dpipesOperator);
afrous.packages.register(dpipesPackage,'dpipes-operators.js');
