...
var flickr = new afrous.UnitActionPackage('Services.Flickr', {
  label : 'Flickr',  
  icon : 'http://www.flickr.com/favicon.ico'
});

flickr.register(new afrous.UnitAction({
  type : 'PhotoFeed',
  ...
  execute : function(request, callback) {
    ...
    afrous.ajax.jsonp.invoke(url, callback, { jsonpParam : 'jsoncallback' }); 
  }
  

}));

afrous.packages.register(flickr, 'flickr.js');
