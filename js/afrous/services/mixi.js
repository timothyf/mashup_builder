      ...
      afrous.ajax.request({
        ...
        function(doc) {
          ...
          Array.prototype.push.apply(friends, 
            mbuilder.lang.map(divs, function(el) {
              var id = parseInt(el.id.substring(2));
              var a = mbuilder.lang.find(
                mbuilder.lang.find(
      ...
      afrous.ajax.request({
        ...
        function(doc) {
          ...
          Array.prototype.push.apply(members, 
            mbuilder.lang.map(lis, function(li) {
...
mixi.register(new afrous.UnitAction({
  ...
  execute : function(request, callback) {
    ...
    afrous.ajax.request({
      ...
      function(doc) {
        var alertArea = mbuilder.lang.find(
          doc.getElementsByTagName('div'),
        ...
        var diaries = mbuilder.lang.map(divs, function(div) {
