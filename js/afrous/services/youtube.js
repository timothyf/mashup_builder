...
var youtube = new afrous.UnitActionPackage('Services.Youtube', {
  label : 'Youtube',
  icon : 'http://www.youtube.com/favicon.ico'
});

youtube.register(new afrous.UnitAction({
  type : 'Videos',
  ...
  execute : function(request, callback) {
    ...
    if (tags && tags.length>0) {
      url += '/'+mbuilder.lang.map(tags,function(t){return encodeURIComponent(t)}).join('/');
    }
...
afrous.packages.register(youtube, 'youtube.js');
